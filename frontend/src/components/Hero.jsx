      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-wrap gap-3 pt-2 text-sm text-zinc-500">
              <span className="px-3 py-1 rounded-full border border-white/10 bg-white/5">AI report generation</span>
              <span className="px-3 py-1 rounded-full border border-white/10 bg-white/5">Patient history tracking</span>
              <span className="px-3 py-1 rounded-full border border-white/10 bg-white/5">Telemedicine scheduling</span>
            </div>
          </div>
